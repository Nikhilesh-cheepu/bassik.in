          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4">
            <div className="flex items-center gap-4">
              ...
              <motion.button
                ...
                className="inline-flex items-center justify-center gap-2 text-white hover:text-white/80 backdrop-blur-md bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl px-3 py-2 transition-all duration-200"
              ...
              <div className="flex-1 relative">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full px-4 py-3 pr-10 text-sm font-semibold backdrop-blur-xl bg-white/10 border-2 border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 transition-all appearance-none cursor-pointer"
                    style={{
