  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <main className="min-h-screen relative z-10">
        ...
        <div className="backdrop-blur-xl bg-black/60 border-b border-white/10 sticky top-0 z-10" style={{ paddingTop: "max(0.5rem, env(safe-area-inset-top))", paddingLeft: "max(1rem, env(safe-area-inset-left))", paddingRight: "max(1rem, env(safe-area-inset-right))" }}>
          <div className="max-w-5xl mx-auto px-4 sm:px-6 py-2 sm:py-3">
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              {/* My Bookings Link - Show only when signed in */}
              {isSignedIn && (
                <Link
                  href={`/${activeBrandId}/my-bookings`}
                  className="inline-flex items-center gap-1.5 sm:gap-2 text-white hover:text-white/80 backdrop-blur-md bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg sm:rounded-xl px-2.5 sm:px-3 py-1.5 sm:py-2 transition-all duration-200 text-xs sm:text-sm font-medium"
                >
        ...
        <div
          className="max-w-5xl mx-auto w-full py-4 sm:py-6 overflow-visible"
          style={{
        ...
        >
          <motion.div
            ...
            className="backdrop-blur-xl bg-white/5 rounded-3xl border border-white/10 p-6 sm:p-8 md:p-10 relative overflow-visible shadow-2xl"
            style={{
