  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-6 relative z-10 space-y-3 pb-32">
        ...
        {/* CTA: Call & WhatsApp - small section after photos (class mors) */}
        <motion.section
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.25 }}
          className="mors backdrop-blur-md bg-white/5 rounded-xl border border-white/10 p-3"
        >
          <h2 className="text-sm font-semibold text-white mb-3">Get in touch</h2>
          <div className="flex flex-wrap gap-2">
            {(() => {
              const phone = venueData.contactPhone || getContactForBrand(selectedBrandId);
              const full = getFullPhoneNumber(phone);
              const msg = venueData.whatsappMessage || getWhatsAppMessageForBrand(selectedBrandId, selectedBrand.shortName);
              ...
              return (
                <>
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg font-medium text-sm text-white transition-all hover:opacity-90"
                  ...
                  <a
                    href={telUrl}
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg font-medium text-sm text-white transition-all hover:opacity-90 border border-white/20"
