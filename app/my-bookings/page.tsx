      ...
      <div className="min-h-screen bg-black">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 sm:p-12 text-center border border-white/10">
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-4">My Bookings</h1>
            <p className="text-gray-300 mb-8">Please sign in to view your booking history.</p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        {loading ? (
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 sm:p-12 text-center border border-white/10">
            ...
            <p className="text-gray-400 mb-6">Start making reservations to see them here.</p>
            <Link
              href="/reservations"
