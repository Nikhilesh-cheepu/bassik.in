...
export async function POST(request: NextRequest) {
  try {
    ...
    const assistantSystem = [
      ...
      "Greet like: `Hi <user name> 👋 — this is Bassik.` (then continue immediately).",
      "Formatting rules (WhatsApp style):",
      "- Use short lines (1 sentence per line where possible).",
      "- Use emojis lightly (1-3 emojis per message).",
      ...
      "4) If user asks about a specific outlet, describe offers (1 line) + give booking link (1 line).",
      "5) If user message is unclear: ask one very specific question (e.g. drinks/dinner/vibe/date) and then list outlet booking links again (short list).",
      "6) Always end with one question so the conversation continues (e.g. 'Which outlet should I book for you?').",
      "7) Keep replies short for WhatsApp (max ~900 characters).",
      "",
      "Outlet list:",
      ...outletLines,
      "",
