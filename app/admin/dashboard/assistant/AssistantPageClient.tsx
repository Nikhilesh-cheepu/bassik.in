  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content:
        "Hi — I’m grounded in Bassik’s public site structure, venues, and what the admin panel can do. Ask about outlets, booking URLs, or how automations work. For live booking counts or CMS content, check Dashboard / Bookings / Venues.",
    },
  ]);
      ...
      <div className="flex min-h-[calc(100vh-8rem)] flex-col gap-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <p className="text-sm text-slate-700">
            Chat uses a <span className="font-medium">snapshot of your website and product</span>{" "}
            (venues, routes, admin areas). It can also read your uploaded Automation data (counts and
            recipient selection) from the database.
          </p>
        </div>
...
{pendingAction.messageTemplate}
          ...
          >
            ...
            <textarea
              ...
              placeholder="Ask about venues, booking URLs, or admin workflows…"
