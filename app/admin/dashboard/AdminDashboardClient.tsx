            ...
            {!isOutlet ? (
              <>
                <Link
                  ...
                  className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
                >
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-lime-500 text-white shadow group-hover:scale-105 transition-transform">
                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-semibold text-slate-900">Site gallery</p>
                    <p className="mt-0.5 text-xs text-slate-500">
                      Homepage teaser + full /gallery masonry.
                    </p>
                  </div>
                  <svg
                    className="h-5 w-5 flex-shrink-0 text-slate-400 group-hover:text-slate-700"
