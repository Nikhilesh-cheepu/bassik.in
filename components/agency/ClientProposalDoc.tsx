      ...
      <div className="mx-auto w-full max-w-[430px] pb-24 lg:max-w-7xl lg:pb-20">
        ...
        <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start lg:gap-12 lg:px-10">
          <main className="space-y-12 px-4 sm:px-6 lg:space-y-16 lg:px-0">
              ...
              <div className="grid gap-3 lg:grid-cols-[1.2fr_0.8fr] lg:gap-4">
                <Card accent>
                  ...
                  <p className="mt-3 text-[13px] font-semibold text-white/60 lg:text-[14px]">
                    The fee will cover complete digital marketing management, including:
                  </p>
                  <div className="mt-3">
            ...
            <Section num="07" title="Advertising Budget">
              <Card>
                <p className="text-[13px] font-semibold text-white/65 lg:text-[14px]">
                ...
                <p className="proposal-label mt-4">Proposed allocation</p>
                <div className="mt-2 grid gap-2 lg:grid-cols-3 lg:gap-3">
                  {AD_PLATFORM_TILES.map((tile) => (
                    <PlatformTileCard key={tile.label} tile={tile} />
                  ))}
                </div>
            ...
            <Section num="08" title="Influencer Marketing Budget">
              <Card accent>
            ...
            <Section num="09" title="Performance-Linked Retainer">
              <Card>
            ...
            <Section num="10" title="Taxation & TDS">
              <Card>
            ...
            <Section num="11" title="Key Areas of Consulting Support">
              <Body>
            ...
            <Section num="12" title="Engagement Philosophy">
              <Card accent>
            ...
            <Section num="13" title="Next Phase">
              <Card>
            ...
            <Section num="14" title="Commercial Summary">
              <div className="lg:hidden">
                <Card accent>
